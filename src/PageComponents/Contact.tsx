...
export default function Contact() {
  return (
    <section className="bg-#F26321 dark:bg-[#191919]">
            ...
            <div className="lg:w-1/2 lg:mx-6">
                ...
                <div className="mt-6 w-80 md:mt-8">
                    ...
                    <div className="flex mt-4 -mx-1.5 ">
                        ...
                        <a className="mx-1.5 dark:hover:text-white text-black transition-colors duration-300 transform hover:text-white" href="https://www.facebook.com/luke.sorrell.961">
                            <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M7 10.2222V13.7778H9.66667V20H13.2222V13.7778H15.8889L16.7778 10.2222H13.2222V8.44444C13.2222 8.2087 13.3159 7.9826 13.4826 7.81591C13.6493 7.64921 13.8754 7.55556 14.1111 7.55556H16.7778V4H14.1111C12.9324 4 11.8019 4.46825 10.9684 5.30175C10.1349 6.13524 9.66667 7.2657 9.66667 8.44444V10.2222H7Z" fill="currentColor" />
                            </svg>
                        </a>

                        <a className="mx-1.5 dark:hover:text-white text-black transition-colors duration-300 transform hover:text-white" href="https://www.instagram.com/_luke.sorrell_/&ved=2ahUKEwjsr4_0ubqGAxWpU0EAHU9JAOwQFnoECBUQAQ&usg=AOvVaw1NYxL_m6S9nlBntWvoOFp9">
                            <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
