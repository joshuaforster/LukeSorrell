    ...
    <div className="container px-6 py-12 mx-auto">
        <div className="lg:flex lg:items-center lg:-mx-6">
            <div className="lg:w-1/2 lg:mx-6">
                <h1 className="text-2xl font-semibold text-black capitalize dark:text-white lg:text-3xl">
                    Contact us for  more info
                </h1>

                <div className="mt-6 space-y-8 md:mt-8">
                    <p className="flex items-start -mx-2">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 mx-2 text-black  dark:text-white " fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                        </svg>

                        <span className="mx-2 text-black truncate w-72  dark:text-white">07454 946769</span>
                    </p>
                    ...
                    <p className="flex items-start -mx-2">
                        ...
                        <span className="mx-2 text-black truncate w-72  dark:text-white">luke.sorrell22@outlook.com</span>
                    </p>
                </div>
                ...
                <div className="mt-6 w-80 md:mt-8">
                    ...
                    <div className="flex mt-4 -mx-1.5 ">
                        ...
                        <a className="mx-1.5 dark:hover:text-white text-black transition-colors duration-300 transform dark:text-white" href="https://www.facebook.com/luke.sorrell.961">
                            <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M7 10.2222V13.7778H9.66667V20H13.2222V13.7778H15.8889L16.7778 10.2222H13.2222V8.44444C13.2222 8.2087 13.3159 7.9826 13.4826 7.81591C13.6493 7.64921 13.8754 7.55556 14.1111 7.55556H16.7778V4H14.1111C12.9324 4 11.8019 4.46825 10.9684 5.30175C10.1349 6.13524 9.66667 7.2657 9.66667 8.44444V10.2222H7Z" fill="currentColor" />
                            </svg>
                        </a>

                        <a className="mx-1.5 dark:hover:text-white text-black transition-colors duration-300 transform dark:text-white" href="https://www.instagram.com/_luke.sorrell_/&ved=2ahUKEwjsr4_0ubqGAxWpU0EAHU9JAOwQFnoECBUQAQ&usg=AOvVaw1NYxL_m6S9nlBntWvoOFp9">
                            <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="mt-8 lg:w-1/2 lg:mx-6">
                <div
                    className="w-full px-8 py-10 mx-auto overflow-hidden bg-#FFEFCE rounded-lg   dark:bg-[#0C0500] lg:max-w-xl">
